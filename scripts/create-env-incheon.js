...
API_ENDPOINT=${process.env.API_ENDPOINT || 'incheon.k3mart.id'}
API_ENDPOINT_ALT=${process.env.API_ENDPOINT || 'incheon.k3mart.id'}
API_CONSIGNMENT_ENDPOINT=${process.env.API_CONSIGNMENT_ENDPOINT || 'training-consignment-api.k3mart.id'}
MAIN_WEBSITE=${process.env.MAIN_WEBSITE || 'incheon.k3mart.id'}
