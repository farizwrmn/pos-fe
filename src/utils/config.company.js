...
const COUCH_URL = production ? (process.env.CLOUDANT_URL || 'https://k3mart:SuperDev123@offline.k3mart.id:443/k3mart') : 'https://k3mart:SuperDev123@offline.k3mart.id:443/k3mart' // 'localhost'
