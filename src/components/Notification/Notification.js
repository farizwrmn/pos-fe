    ...
    window.Notification.requestPermission((permission) => {
      ...
      this.setState({
        ...
        if (result) {
          ...
          this.props.onPermissionGranted()
          let opt = this.props.homeOptions
          console.log(opt)
          if (typeof opt.tag !== 'string') {
            opt.tag = `home-notification-${seq()}`
          }
          if (!this.homeNotification[opt.tag]) {
            let n = new window.Notification(this.props.homeTitle, opt)
            n.onshow = (e) => {
            ...
            this.homeNotification[opt.tag] = n
          }
        } else {
          this.props.onPermissionDenied()
        }
