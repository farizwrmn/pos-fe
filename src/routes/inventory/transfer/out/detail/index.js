  ...
  return (<div className="wrapper">
    <Row>
      ...
      <Col lg={17}>
        <div className="content-inner-zero-min-height">
          <h1>Items</h1>
          <Button type="danger" icon="delete" loading={loading.effects['transferOutDetail/queryDetail']} disabled={data.length > 0 ? (!data[0].active || !data[0].status) : 0} onClick={() => voidTrans()}>Void</Button>
