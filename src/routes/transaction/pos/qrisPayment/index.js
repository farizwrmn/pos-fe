...
import DynamicQrisTemplate from '../../customer-view/DynamicQrisTemplate'
...
class QrisPayment extends Component {
  ...
  render () {
    ...
    const dynamicQrisTemplateProps = {
      ...
      qrisImage: lstorage.getDynamicQrisImage(),
      dynamicQrisTimeLimit: 1000000,
      qrisMerchantTradeNo: ''
    }

    return (
      <Row style={{ padding: '0 20px 0 20px' }}>
        <Col sm={0} md={8}><DynamicQrisTemplate {...dynamicQrisTemplateProps} /></Col>
        <Col sm={0} md={16}>
