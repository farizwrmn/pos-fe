  ...
  const createPdfLineItems = (tabledata) => {
    const headersGroup = {
      top: {
        ...
        col_8: {},
        col_9: { fontSize: 12, text: 'PENJUALAN', colSpan: 3, alignment: 'center' },
        col_10: {},
        col_11: {},
        col_12: { fontSize: 12, text: 'ADJ OUT + RETUR BELI', colSpan: 2, alignment: 'center' },
        col_13: {},
        col_14: { fontSize: 12, text: 'SALDO AKHIR', colSpan: 2, alignment: 'center' },
        col_15: {},
        col_16: {},
      },
    }
    const headers = {
      top: {
        ...
        col_10: { fontSize: 12, text: 'NET SALES', alignment: 'center' },
        col_11: { fontSize: 12, text: 'AMOUNT HPP', alignment: 'center' },
        col_12: { fontSize: 12, text: 'QTY', alignment: 'center' },
        col_13: { fontSize: 12, text: 'AMOUNT HPP', alignment: 'center' },
        col_14: { fontSize: 12, text: 'QTY', alignment: 'center' },
        col_15: { fontSize: 12, text: 'AMOUNT HPP', alignment: 'center' },
        col_16: { fontSize: 12, text: 'LABA-RUGI', alignment: 'center' },
      },
    }
    ...
    for (let key in rows) {
      if (rows.hasOwnProperty(key)) {
        ...
        row.push({ text: data.valuePrice.toLocaleString(['ban', 'id'], { minimumFractionDigits: 2, maximumFractionDigits: 2 }), alignment: 'right', fontSize: 11 })        
        ...
        row.push({ text: (parseFloat(data.valuePrice) - parseFloat(data.posPrice)).toLocaleString(['ban', 'id'], { minimumFractionDigits: 2, maximumFractionDigits: 2 }), alignment: 'right', fontSize: 11 })
        body.push(row)
      }
      counter += 1
    }
    ...
    totalRow.push({ text: `${valuePrice.toLocaleString(['ban', 'id'], { minimumFractionDigits: 2, maximumFractionDigits: 2 })}`, alignment: 'right', fontSize: 12 })
    ...
    totalRow.push({ text: `${(parseFloat(valuePrice) - parseFloat(posPrice)).toLocaleString(['ban', 'id'], { minimumFractionDigits: 2, maximumFractionDigits: 2 })}`, alignment: 'right', fontSize: 12 })
    body.push(totalRow)
    return body
  }
        ...
        content: [
          {
            writable: true,
            table: {
              widths: ['4%', '12%', '5%', '7%', '5%', '6%', '5%', '6%', '5%', '7%', '7%', '5%', '7%', '5%', '7%', '7%'],
              headerRows: 1,
              body,
            },
            layout: 'noBorder',
