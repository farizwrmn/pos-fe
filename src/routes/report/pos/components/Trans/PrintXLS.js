...
const PrintXLS = ({ listTrans, dataSource, fromDate, toDate, storeInfo }) => {
  ...
  const handleXLS = () => {
    if (fromDate === '' && toDate === '') {
      ...
      sheet.getCell('F2').value = 'LAPORAN PENJUALAN PER FAKTUR'
