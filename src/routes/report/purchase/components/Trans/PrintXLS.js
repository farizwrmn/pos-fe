...
const PrintXLS = ({ listTrans, fromDate, toDate, storeInfo }) => {
  ...
  const createTableBody = (list) => {
    ...
    for (let key in rows) {
      if (rows.hasOwnProperty(key)) {
        ...
        row.push({ value: parseFloat(data.total), numFmt: numberFormat.format(data.total, 2), alignment: { vertical: 'middle', horizontal: 'right' }, font: styles.tableBody, border: styles.tableBorder })
        row.push({ value: parseFloat(data.discount), numFmt: numberFormat.format(data.discount, 2), alignment: { vertical: 'middle', horizontal: 'right' }, font: styles.tableBody, border: styles.tableBorder })
        row.push({ value: parseFloat(data.dpp), numFmt: numberFormat.format(data.dpp, 2), alignment: { vertical: 'middle', horizontal: 'right' }, font: styles.tableBody, border: styles.tableBorder })
        row.push({ value: parseFloat(data.ppn), numFmt: numberFormat.format(data.ppn, 2), alignment: { vertical: 'middle', horizontal: 'right' }, font: styles.tableBody, border: styles.tableBorder })
        row.push({ value: parseFloat(data.rounding), numFmt: numberFormat.format(data.rounding, 2), alignment: { vertical: 'middle', horizontal: 'right' }, font: styles.tableBody, border: styles.tableBorder })
        row.push({ value: parseFloat(data.netto), numFmt: numberFormat.format(data.netto, 2), alignment: { vertical: 'middle', horizontal: 'right' }, font: styles.tableBody, border: styles.tableBorder })
        body.push(row)
      }
      start += 1
    }
  ...
  const tableFooter = [
    [
      ...
      { value: grandTotal, numFmt: numberFormat.format(grandTotal, 2), alignment: { vertical: 'middle', horizontal: 'center' }, font: styles.tableFooter, border: styles.tableBorder },
      { value: discountTotal, numFmt: numberFormat.format(discountTotal, 2), alignment: { vertical: 'middle', horizontal: 'center' }, font: styles.tableFooter, border: styles.tableBorder },
      { value: dppTotal, numFmt: numberFormat.format(dppTotal, 2), alignment: { vertical: 'middle', horizontal: 'center' }, font: styles.tableFooter, border: styles.tableBorder },
      { value: ppnTotal, numFmt: numberFormat.format(ppnTotal, 2), alignment: { vertical: 'middle', horizontal: 'center' }, font: styles.tableFooter, border: styles.tableBorder },
      { value: roundingTotal, numFmt: numberFormat.format(roundingTotal, 2), alignment: { vertical: 'middle', horizontal: 'center' }, font: styles.tableFooter, border: styles.tableBorder },
      { value: nettoTotal, numFmt: numberFormat.format(nettoTotal, 2), alignment: { vertical: 'middle', horizontal: 'center' }, font: styles.tableFooter, border: styles.tableBorder }
    ]
  ]
