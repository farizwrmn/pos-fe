    ...
    stack: [
      ...
      },
      {
        table: {
          ...
          body: [
            [{ text: 'NO TRANS', fontSize: 11 }, ':', { text: (`${itemPrint.transNo}\n${itemPrint.supplier.supplierName}` || '').toString(), fontSize: 11 }, {}, {}, {}, {}],
            [{ text: 'NO REFERENCE', fontSize: 11 }, ':', { text: (`${itemPrint.referenceTransNo}` || '').toString(), fontSize: 11 }, {}, {}, {}, {}],
            [{ text: 'NO PO', fontSize: 11 }, ':', { text: (`${itemPrint.purchaseOrder.transNo}` || '').toString(), fontSize: 11 }, {}, {}, {}, {}]
          ]
        },
        layout: 'noBorders'
      },
