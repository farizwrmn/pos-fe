        ...
        <div className="content-inner-zero-min-height">
          ...
          <div className={styles.content}>
            <Row>
              ...
              <Col span={12}><strong>BR-{moment(data.createdAt, 'YYYY-MM-DD HH:mm:ss').format('YYMM')}{String(data.id).padStart(8, '0')}</strong></Col>
            </Row>
            <Row>
            ...
            <Row>
              ...
              <Col span={12}>{moment(data.createdAt, 'YYYY-MM-DD HH:mm:ss').format('DD-MMM-YYYY HH:mm')}</Col>
            </Row>
            <Row>
            ...
            <Row>
              ...
              <Col span={12}>{moment(data.updatedAt, 'YYYY-MM-DD HH:mm:ss').format('DD-MMM-YYYY HH:mm')}</Col>
            </Row>
