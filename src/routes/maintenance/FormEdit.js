        ...
        validateFields((errors) => {
            ...
            Modal.confirm({
                ...
                onOk() {
                    ...
                    data.usingWo = data.woReference === null || data.woReference === '' ? false : true
                    onOk(data)
                    setFormItem({})
                    resetFields()
                },
            ...
            <Row>
                ...
                <Col md={12}>
                    ...
                    <FormItem label="Ref" help={item.woReference === '' || item.woReference === null || item.woReference === undefined ? 'you are not using Work Order' : 'you are using Work Order'} {...formItemLayout}>
                        ...
                        })(<Input disabled={defaultRole === 'OWN' ? false : true} style={{ width: '100%', height: '32px', backgroundColor: '#ffffff' }} />)}
                    </FormItem>
                </Col>
            </Row>
