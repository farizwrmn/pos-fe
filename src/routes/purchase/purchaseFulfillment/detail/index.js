...
const Detail = ({ purchaseFulfillment, app, dispatch }) => {
  const { listDetail, data } = purchaseFulfillment
...
export default connect(({ app, purchaseFulfillment }) => ({ app, purchaseFulfillment }))(Detail)
