...
const Filter = ({
  ...
  const handleSubmit = () => {
    ...
    fields.serviceName = fields.searchName
  ...
  return (
    <Row gutter={24}>
      ...
      <Col {...ColProps} xl={{ span: 4 }} md={{ span: 8 }}>
        {getFieldDecorator('searchName', { initialValue: serviceName })(<Search placeholder="Search Name" size="large" onSearch={handleSubmit} style={{ display }} />)}
      </Col>
