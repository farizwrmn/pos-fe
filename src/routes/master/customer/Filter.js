      ...
      <Panel header="Search" key="1">
        <Row gutter={24}>
          <Col {...ColProps} xl={{ span: 4 }} md={{ span: 8 }}>
            {getFieldDecorator('memberName', { initialValue: name })(
              <Search placeholder="Search Customer Name" size="large" onSearch={handleSubmit} />
            )}
          </Col>
