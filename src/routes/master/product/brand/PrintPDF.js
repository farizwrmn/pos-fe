...
const PrintPDF = ({ dataSource, user, storeInfo }) => {
  let tableHeaders = {
    top: {
      col_1: { text: 'BRAND CODE', style: 'tableHeader', alignment: 'center', bold: true, fontSize: 13, style: 'headers' },
      col_2: { text: 'BRAND NAME', style: 'tableHeader', alignment: 'center', bold: true, fontSize: 13, style: 'headers' },
    },
  }
