...
const Filter = ({
  ...
  const handleSubmit = () => {
    ...
    fields.productName = fields.searchName
  ...
  return (
    <Row gutter={24}>
      ...
      <Col {...ColProps} xl={{ span: 4 }} md={{ span: 8 }}>
        {getFieldDecorator('searchName', { initialValue: productName })(<Search placeholder="Search Name" size="large" onSearch={handleSubmit} style={{ display }} />)}
      </Col>
