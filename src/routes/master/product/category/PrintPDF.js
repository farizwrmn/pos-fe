...
const PrintPDF = ({ dataSource, user, storeInfo }) => {
  let tableHeaders = {
    top: {
      col_1: { text: 'CATEGORY CODE', style: 'tableHeader', alignment: 'center', bold: true, fontSize: 13 },
      col_2: { text: 'CATEGORY NAME', style: 'tableHeader', alignment: 'center', bold: true, fontSize: 13 }
    }
  }
