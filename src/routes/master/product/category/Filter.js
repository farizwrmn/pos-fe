...
const Filter = ({
  ...
  const handleSubmit = () => {
    ...
    fields.categoryName = fields.searchName
  ...
  return (
    <Row gutter={24}>
      ...
      <Col {...ColProps} xl={{ span: 4 }} md={{ span: 8 }}>
        {getFieldDecorator('searchName', { initialValue: categoryName })(<Search placeholder="Search Name" size="large" onSearch={handleSubmit} style={{ display }} />)}
      </Col>
