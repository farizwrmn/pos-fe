...
class AdvanceForm extends Component {
  onChangeInput = (itemSelection, value) => {
    const {
      dispatch,
      list = [],
      setCashValue
  ...
  updateSetoran = (itemSelection, value) => {
    const {
      dispatch,
      listSetoran = []
    } = this.props
                    ...
                    return (
                      <div style={{ textAlign: 'center' }}>
                        <FormItem hasFeedback>
                          ...
                          })(<InputNumber min={0} onChange={(value) => { this.onChangeInput(column, value) }} />)}
                        </FormItem>
                      </div>
                    )
                  }}
                          ...
                          return (
                            <div style={{ textAlign: 'center' }}>
                              <FormItem hasFeedback>
                                ...
                                })(<InputNumber style={{ width: 200 }} min={0} onChange={(value) => { this.updateSetoran({ key: 'A', type: 'edcAmount' }, value) }} />)}
                              </FormItem>
                            </div>
                          )
                        }}
                            ...
                            <div style={{ textAlign: 'center' }}>
                              <FormItem hasFeedback>
                                {getFieldDecorator('edcTotal', {
                                  ...
                                  min={0}
                                  onChange={(value) => { this.updateSetoran({ key: 'A', type: 'edcTotal' }, value) }}
                                />)}
                              </FormItem>
                            </div>
                          )
                          ...
                          return (
                            <div style={{ textAlign: 'center' }}>
                              <FormItem hasFeedback>
                                ...
                                })(<InputNumber style={{ width: 200 }} min={0} onChange={(value) => { this.updateSetoran({ key: 'C', type: 'voidAmount' }, value) }} />)}
                              </FormItem>
                            </div>
                          )
                        }}
                            ...
                            <div style={{ textAlign: 'center' }}>
                              <FormItem hasFeedback>
                                {getFieldDecorator('voidTotal', {
                                  ...
                                  parser={value => value.replace(/\$\s?|(,*)/g, '')}
                                  min={0}
                                  onChange={(value) => { this.updateSetoran({ key: 'C', type: 'voidTotal' }, value) }}
                                />)}
                              </FormItem>
                            </div>
                          )
                            ...
                            <div style={{ textAlign: 'center' }}>
                              <FormItem hasFeedback>
                                {getFieldDecorator('grabAmount', {
                                  ...
                                  min={0}
                                  onChange={(value) => {
                                    this.updateSetoran({ key: 'G', type: 'grabAmount' }, value)
                                  }}
                                />)}
                              </FormItem>
                            </div>
