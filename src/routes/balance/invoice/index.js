...
const Invoice = ({ posSetoran, physicalMoneyDeposit, balance, balanceDetail, paymentOpts }) => {
  ...
  const { listEdc, listVoid, listEdcInput, listVoidInput, listGrab, listGrabInput, listTransaction, countTransaction, listVoidTransaction, listCanceledPos } = posSetoran
    ...
    <LocaleProvider locale={enUS}>
      <div className={styles.invoiceMini}>
        ...
        <Body
          ...
          listGrabInput={listGrabInput}
          listCanceledPos={listCanceledPos}
