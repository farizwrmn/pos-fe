...
const Detail = ({ transferSchedule, app, dispatch }) => {
  const { listDetail, data } = transferSchedule
...
export default connect(({ app, transferSchedule }) => ({ app, transferSchedule }))(Detail)
