...
const Detail = ({ transferFulfillment, app, dispatch }) => {
  const { listDetail, data } = transferFulfillment
...
export default connect(({ app, transferFulfillment }) => ({ app, transferFulfillment }))(Detail)
