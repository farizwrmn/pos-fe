...
import { query, add, edit, remove } from '../services/customertype'
...
export default modelExtend(pageModel, {
  ...
  effects: {
    ...
    * edit ({ payload }, { select, call, put }) {
      const customertypeId = yield select(({ customertype }) => customertype.currentItem.TypeCode)
      const newcustomertype = { ...payload, customertypeId }
