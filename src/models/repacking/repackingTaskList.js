...
import { query, queryById, add, edit, remove } from 'services/repacking/repackingTaskList'
...
export default modelExtend(pageModel, {
  ...
  effects: {
    ...
    * querySequence (payload, { select, call, put }) {
      ...
      const currentItem = yield select(({ repackingTaskList }) => repackingTaskList.currentItem)
    ...
    * addRecipe ({ payload = {} }, { select, call, put }) {
      const detail = yield select(({ repackingTaskList }) => repackingTaskList.detail)
    ...
    * edit ({ payload }, { select, call, put }) {
      const id = yield select(({ repackingTaskList }) => repackingTaskList.currentItem.id)
