...
import {
  generalLedger,
  trialBalance
} from 'services/taxReport/ledger'
    ...
    setup ({ dispatch, history }) {
      history.listen((location) => {
        if (location.query.from && location.query.to && (
          location.pathname === '/tools/report/general-ledger'
        ...
        if (location.pathname === '/tools/report/trial-balance' && location.query.from && location.query.to) {
          dispatch({
